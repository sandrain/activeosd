...
#define list_first_entry(ptr, type, member) \
	list_get_entry((ptr)->next, type, member)

#define list_last_entry(ptr, type, member) \
	list_get_entry((ptr)->prev, type, member)
...
#define list_for_each_entry_safe(pos, n, head, member)			\
	for (pos = list_get_entry((head)->next, typeof(*pos), member),	\
		n = list_get_entry(pos->member.next, typeof(*pos), member);	\
	     &pos->member != (head); 					\
	     pos = n, n = list_get_entry(n->member.next, typeof(*n), member))
