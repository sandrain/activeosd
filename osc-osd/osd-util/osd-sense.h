...
#define OSD_SSK_VENDOR_SPECIFIC (0x09)	/** used by EXECUTE_KERNEL command */
...
/** returning task id to client. (EXECUTE_KERNEL command) */
#define	OSD_ASC_SUBMITTED_TASK_ID (0x8800)
